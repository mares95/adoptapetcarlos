...
/*function crearSolicitud(req, res){
    //Instanciaremos un nuevo Solicitud utiliando la clase Solicitud
...
/*function obtenerSolicitud(req, res){
    // SImulando dos Solicitud y respondiendolos
    var solicitud1 = new Solicitud(1, 'Juan', 'Vega', 'juan@vega.com')
    var solicitud2 = new Solicitud(2, 'Monserrat', 'Vega', 'mon@vega.com')
...
function modificarSolicitud(req, res){
    // Simulando un Solicitud previamente existente que el Solicitud utiliza
